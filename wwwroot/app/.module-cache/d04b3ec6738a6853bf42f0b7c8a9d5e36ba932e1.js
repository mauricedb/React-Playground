...
var MovieItem = React.createClass({displayName: "MovieItem",
    render: function () {
        ...
        return React.createElement("div", {class: "row well", "ng-repeat": "movie in movies"}, 
            React.createElement("div", {class: "col-sm-2 hidden-xs"}, 
                React.createElement("img", {"ng-src": "{movie.posters.profile}", 
                    "ng-if": "showMoviePoster()", 
            ...
            React.createElement("div", {class: "col-sm-10"}, 
                ...
                React.createElement("span", {class: "pull-left"}, 
                    React.createElement("a", {class: "btn btn-primary", 
                        "ng-href": "{{'#/movies/' + movie.id}}"}, "Read More")
                ), 
                React.createElement("span", {class: "pull-right"}, 
                    React.createElement("span", {"ng-repeat": "genre in movie.genres"}, 
                        React.createElement("button", {class: "btn btn-info  btn-xs", 
